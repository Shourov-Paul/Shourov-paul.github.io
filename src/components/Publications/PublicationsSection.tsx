...
const PublicationCard = ({ pub }: { pub: PublicationItem }) => {
  ...
  return (
    <div className="relative group flex flex-col md:flex-row gap-6 py-8 border-b border-border/60 last:border-b-0 transition-all duration-300">
      ...
      <div className="flex-grow flex flex-col pr-0 md:pr-16">
        {/* Title */}
      ...
      <div className="absolute right-0 top-8 text-5xl md:text-6xl font-extrabold tracking-tighter text-neutral/5 select-none pointer-events-none transition-colors duration-300 group-hover:text-accent/10">
        {pub.year}
      </div>
    </div>
  )
